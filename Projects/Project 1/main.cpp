...
void fruityTest(void) {
	...
	char article[] = "appl I ate an appl an and a pear\n";
...
void dogTest(void) {
	...
	char article[] = "dalmation beagle retriever poodles";
...
void punctuationTests(void) {
	...
	char article[] = "I think I' can't!, but I can't. I think I do, but I don't";
